...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
		<span class="woocommerce-form-row__label"><?php esc_html_e( 'Email address', 'woocommerce' ); ?></span>
		<span class="woocommerce-Input woocommerce-Input--text input-text" aria-readonly="true"><?php echo esc_html( $user->user_email ); ?></span>
	</p>
