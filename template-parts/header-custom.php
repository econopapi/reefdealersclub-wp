	...
	<div class="rdc-header-container">
		...
		<div class="rdc-search">
			<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
				<input type="search" class="search-field" placeholder="Buscar en Reef Dealers Club" name="s" value="<?php echo get_search_query(); ?>" />
				<button type="button" class="search-clear" aria-label="Limpiar busqueda" hidden>
		...
		<div class="rdc-header-actions">
			...
			<a href="<?php echo esc_url( function_exists( 'wc_get_cart_url' ) ? wc_get_cart_url() : '#' ); ?>" class="rdc-cart">
				...
				?>
				<span class="rdc-cart-count" <?php echo $cart_count === 0 ? 'style="display:none;"' : ''; ?>><?php echo esc_html( $cart_count ); ?></span>
			</a>
		</div>
	</div>
</header>
